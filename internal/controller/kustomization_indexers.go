...
//			dd = append(dd, r.Lookup(ctx, art, indexKey, fmt.Sprintf("%s/%s/%s/%s", actionutils.ExtractGroupName(ref.APIVersion), ref.Kind, art.Namespace, ref.Name))...)
//		}
//
//		sorted, err := dependency.Sort(dd)
//		if err != nil {
...
//		}
//
//		key := actionutils.KeyForReference(k, k.Spec.SourceRef)
//		if key != "" {
//			return []string{key}
//		}
//
