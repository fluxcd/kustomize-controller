...
func (in *IgnoreRule) DeepCopyInto(out *IgnoreRule) {
	*out = *in
	...
	if in.BeforeDryRun != nil {
		in, out := &in.BeforeDryRun, &out.BeforeDryRun
		*out = new(bool)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VaultInstance) DeepCopyInto(out *VaultInstance) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VaultInstance.
func (in *VaultInstance) DeepCopy() *VaultInstance {
	if in == nil {
		return nil
	}
