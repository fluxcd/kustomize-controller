...
// TEMPORARY, for local testing only: points at the ContextWithSecretVarsCollector
// branch pushed to https://github.com/dipti-pai/pkg/tree/kustomize-substitute-with-vars
// (fluxcd/pkg PR not yet opened). Remove before merging; replace with a tagged
// github.com/fluxcd/pkg/kustomize release once that change lands upstream.
replace github.com/fluxcd/pkg/kustomize => github.com/dipti-pai/pkg/kustomize v0.0.0-20260914220310-56fb7e51957c
