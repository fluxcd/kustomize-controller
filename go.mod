...
// Replace pkg/ssa with fork containing DriftIgnoreRules support.
replace github.com/fluxcd/pkg/ssa => github.com/dipti-pai/pkg/ssa v0.51.1-0.20260401195426-48491299041d
