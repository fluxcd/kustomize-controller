...
<em>
<a href="#kustomize.toolkit.fluxcd.io/v1beta1.PreBuild">
PreBuild
</a>
</em>
</td>
<td>
<em>(Optional)</em>
<p>PreBuild describes which actions to perform on the YAML manifest
before it is built by the kustomize overlay.</p>
</td>
</tr>
<tr>
<td>
...
<h3 id="kustomize.toolkit.fluxcd.io/v1beta1.PreBuild">PreBuild
</h3>
<p>
(<em>Appears on:</em>
<a href="#kustomize.toolkit.fluxcd.io/v1beta1.KustomizationSpec">KustomizationSpec</a>)
...
<a href="#kustomize.toolkit.fluxcd.io/v1beta1.PreBuild">PreBuild</a>)
</p>
